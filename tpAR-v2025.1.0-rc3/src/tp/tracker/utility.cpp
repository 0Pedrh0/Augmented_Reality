    ...
    switch( patternType )
    {
        ...
        case Pattern::CHESSBOARD:
            ...
            if( found )
            {
                ...
                /******************************************************************/
                cvtColor( rgbimage, viewGrey, cv::COLOR_BGR2GRAY );
                ...
                // --> see cornerSubPix
                /******************************************************************/
                TermCriteria criteria =  TermCriteria( TermCriteria::EPS + TermCriteria::COUNT, 400, 0.1 ); // changer ça ?
                cornerSubPix(viewGrey, pointbuf, Size(11,11), Size(-1,-1), criteria );
            }
            break;
